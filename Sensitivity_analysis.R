...
# match the data. This is to avoid having too many datapoints without matching results (as fixed d13C results in less flexibility of the model).
...
# Renames "Age" in stal_data to ts for consistency
colnames(stal_data)[2]          <- "ts"
...
# DCP over time. Each dot represents a solution and the colour-coding shows the soil pCO2, cave pCO2, gas volume, and soil R14C of that solution.
DCP.soilCO2 <- 
